-- =====================================================
-- WAKAA - DONNÉES DE TEST
-- =====================================================

-- =====================================================
-- 1. INSERTION DE PROFILS DE TEST
-- =====================================================
INSERT INTO profiles (id, email, password_hash, full_name, phone, role, email_verified, onboarding_completed) VALUES
(uuid_generate_v4(), 'admin@wakaa.cm', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/A5/jF3kkS', 'Admin Wakaa', '+237670000001', 'admin', true, true),
(uuid_generate_v4(), 'merchant1@wakaa.cm', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/A5/jF3kkS', 'Jean Boutique', '+237670000002', 'merchant', true, true),
(uuid_generate_v4(), 'merchant2@wakaa.cm', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj/A5/jF3kkS', 'Marie Fashion', '+237670000003', 'merchant', true, true);

-- =====================================================
-- 2. INSERTION DE MARCHANDS DE TEST
-- =====================================================
INSERT INTO merchants (user_id, business_name, whatsapp_number, email, slug, subscription_plan, profile_image_url, address, city) VALUES
((SELECT id FROM profiles WHERE email = 'merchant1@wakaa.cm'), 'Boutique Jean', '+237670123456', 'merchant1@wakaa.cm', 'boutique-jean', 'standard', 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400', '123 Rue de la Paix', 'Douala'),
((SELECT id FROM profiles WHERE email = 'merchant2@wakaa.cm'), 'Marie Fashion', '+237680234567', 'merchant2@wakaa.cm', 'marie-fashion', 'premium', 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400', '456 Avenue Kennedy', 'Yaoundé');
...
(1, '+237671111111', 'Client Test 1', 'client1@test.com', '123 Rue A', 'Douala', 3, 75000),
(1, '+237672222222', 'Client Test 2', 'client2@test.com', '456 Rue B', 'Douala', 2, 50000),
(2, '+237673333333', 'Client Test 3', 'client3@test.com', '789 Rue C', 'Yaoundé', 5, 125000),
(2, '+237674444444', 'Client Test 4', 'client4@test.com', '321 Rue D', 'Yaoundé', 1, 25000);
...
-- =====================================================
INSERT INTO orders (merchant_id, customer_id, order_number, subtotal_amount, total_amount, status, payment_status, shipping_address) VALUES
(1, 1, 'WK-2025-001', 40000, 42000, 'delivered', 'paid', '{"address": "123 Rue A", "city": "Douala", "phone": "+237671111111"}'),
(1, 2, 'WK-2025-002', 15000, 17000, 'pending', 'pending', '{"address": "456 Rue B", "city": "Douala", "phone": "+237672222222"}'),
(2, 3, 'WK-2025-003', 63000, 65000, 'shipped', 'paid', '{"address": "789 Rue C", "city": "Yaoundé", "phone": "+237673333333"}'),
(2, 4, 'WK-2025-004', 28000, 30000, 'processing', 'paid', '{"address": "321 Rue D", "city": "Yaoundé", "phone": "+237674444444"}');
...
('whatsapp', 'message_received', 1, NULL, '{"from": "+237671111111", "message": "Je veux commander", "timestamp": "2025-01-03T10:30:00Z"}', 'processed', CURRENT_TIMESTAMP - INTERVAL '2 hours', true),
('cinetpay', 'payment_completed', 1, 1, '{"transaction_id": "CP_TXN_001", "amount": 42000, "status": "completed"}', 'processed', CURRENT_TIMESTAMP - INTERVAL '2 days', true),
('cinetpay', 'payment_completed', 2, 3, '{"transaction_id": "CP_TXN_002", "amount": 65000, "status": "completed"}', 'processed', CURRENT_TIMESTAMP - INTERVAL '1 day', true);